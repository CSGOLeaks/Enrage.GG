...
//	VMP_IMPORT void VMP_API (const char*);
//	VMP_IMPORT void VMP_API VMProtectBeginVirtualizationLockByKey(const char*);
//	VMP_IMPORT void VMP_API LockByKey(const char*);
...
//	VMP_IMPORT const char* VMP_API (const char* value);
...
#include <sdk/VirtualizerSDK_FISH_LITE.h>
