...
#include "cutl_fixed_mem.hpp"
#include "cutl_block_mem.hpp"
//#include "misc.h"
...
template < class T >
class CUtlFixedLinkedList : public CUtlLinkedList< T, intptr_t, true, intptr_t, CUtlFixedMemory< UtlLinkedListElem_t< T, uintptr_t > > >
{
public:
...
void  CUtlLinkedList<T, S, ML, I, M>::LinkBefore(I before, I elem)
{
	...
	auto pNewElem = &InternalElement(elem);
	...
	else
	{
		...
		auto beforeElem = &InternalElement(before);
