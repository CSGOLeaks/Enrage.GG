...
enum ImGuiSliderFlags_
{
	...
	ImGuiSliderFlags_RenderValue			= 1 << 1
};
...
enum ImGuiItemFlags_
{
	...
	ImGuiItemFlags_TabButton					= 1 << 6,  // false
...
public:
    ...
    float       TitleBarHeight() const                  { return (Flags & ImGuiWindowFlags_CoolStyle) ? 40.f : ((Flags & ImGuiWindowFlags_NoTitleBar) ? 0.0f : CalcFontSize() + GImGui->Style.FramePadding.y * 2.0f); }
