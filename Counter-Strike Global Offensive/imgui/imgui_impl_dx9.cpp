...
void ImGui_ImplDX9_RenderDrawLists(ImDrawData* draw_data)
{
	...
	g_pd3dDevice->SetSamplerState(NULL, D3DSAMP_ADDRESSU, D3DTADDRESS_WRAP);
	g_pd3dDevice->SetSamplerState(NULL, D3DSAMP_ADDRESSV, D3DTADDRESS_WRAP);
	g_pd3dDevice->SetSamplerState(NULL, D3DSAMP_ADDRESSW, D3DTADDRESS_WRAP);
	g_pd3dDevice->SetSamplerState(NULL, D3DSAMP_SRGBTEXTURE, NULL);
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            else
            {
				...
				//g_pd3dDevice->SetPixelShader((LPDIRECT3DPIXELSHADER9)pcmd->ShaderID);
